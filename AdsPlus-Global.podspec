#
#  Be sure to run `pod spec lint adsplus-ios-cn.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  这个是AdsPlus国外版本.的cocoapods
                   DESC

  spec.homepage     = "https://github.com/adsplusteam/adsplus-ios-global"
  ...
  spec.source       = { :git => "https://github.com/adsplusteam/adsplus-ios-global.git", :tag => "#{spec.version}" }
  ...
  spec.vendored_frameworks = 'AdsPlus-Global/ADP.framework'
  ...
  #
   ...
   spec.resource  = "AdsPlus-Global/ADPBundle.bundle"
  ...
  # spec.xcconfig = { "HEADER_SEARCH_PATHS" => "$(SDKROOT)/usr/include/libxml2" }
   ...
   spec.dependency "Google-Mobile-Ads-SDK", "11.15.0"
